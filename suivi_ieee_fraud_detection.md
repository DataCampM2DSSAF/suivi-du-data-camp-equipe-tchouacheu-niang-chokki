...
> Notre réseau de neurones est assez standard. Nous utiliserons la couche d'intégration pour les catégories et les données numériques passeront par des couches denses à propagation directe.
